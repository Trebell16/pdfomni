    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Searchers often look for a Batch PDF converter, Batch PDF merger, combine PDFs in bulk, Bulk PDF compressor, reduce PDF size batch, bulk PDF to JPG, Extract pages from PDF in bulk, Add watermark to multiple PDFs at once, How to batch process PDF files, How to convert multiple PDFs at once, or Best batch PDF tools for Windows and Mac. PDFOmni describes those workflows directly, but the important difference is that processing is designed to happen in your browser instead of a remote upload queue.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'The long-term goal is to build one of the best privacy-focused PDF toolkits available. Compared with basic browser utilities, PDFOmni invests in deeper local processing such as world-class Edit PDF technology, true PDF stream editing within your browser, embedded-font handling, selectable-text preservation, large-file workflows, and visual document automation.',
        ],
      },
    ],
    faq: [],
